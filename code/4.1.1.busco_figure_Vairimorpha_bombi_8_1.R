...
# Output
my_output <- paste("../../results_Vairimorpha_bombi_8_1/4.isolated_microsporidia_sequences_raw/busco_analysis_results/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('busco_analysis_results', 'busco_analysis_results', 'busco_analysis_results', 'busco_analysis_results')
...
my_percentage <- c(29.7, 17.7, 9.0, 43.6)
my_values <- c(178, 106, 54, 262)
