...
all_orthomcl="/home/vlb19/Documents/Coding/2022-23_Vairimorpha_bombi_de_novo_genome/results_Vairimorpha_bombi_8.1-3/10.SynIma_runs/All_species_vs_1x/all_orthomcl.out"

# Save single and multi-copy orthogroups that are shared by all microsporidia 
grep "39 taxa" $all_orthomcl > all_shared_orthogroups

# Save single copy orthogroups that are shared by all microsporidia 
grep "39 genes,39 taxa" $all_orthomcl > shared_sc_orthogroups
...
synima_run_files='/home/vlb19/Documents/Coding/2022-23_Vairimorpha_bombi_de_novo_genome/results_Vairimorpha_bombi_8.1-3/10.SynIma_runs/All_species_vs_1x'
...
#sed -i 's/ gene_product.*//g' *_peps
#sed -i 's/.* \[/>/g' *_peps
#sed -i 's/^>file.*/>Vairimorpha_bombi_8.1-3/g' *_peps

# Change spaces to underscores in lines beginning ">"
#sed -i '/^>/s/ /_/g' *_peps
